...
class FAQ_CPT
{
	...
	public static $cpt_name = 'faq_wpc';
	...
	public static function init()
	{
		...
		add_filter('post_updated_messages', array(__CLASS__, 'cpt_updated_messages'));
	}
	...
	public static function add_faq_shortcode_column()
	{
		...
		add_filter('manage_' . self::$cpt_name . '_posts_columns', function ($columns) {
			$columns[self::$cpt_name] = __('Shortcode', 'genesis-simple-faq');
			return $columns;
		});
		add_action('manage_' . self::$cpt_name . '_posts_custom_column', function ($column_name, $post_ID) {
			if (self::$cpt_name === $column_name) {
